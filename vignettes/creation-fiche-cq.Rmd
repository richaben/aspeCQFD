...
resource_files:
  - inst/exemples/fiche_CQ_donnees_station_03174000_005.html
vignette: >
...
```{r, echo=FALSE, eval=T}
htmltools::tags$iframe(title = "Exemple fiche", 
                       height = 600, 
                       width = 800,
                       src = system.file("inst/exemples", "fiche_CQ_donnees_station_03174000_005.html",
                                         package = "aspeCQFD"))
```
