---
title: "Créer une fiche CQ pour une station"
...
Si l'on souhaite créer les tables individuellement, voici comment procéder :
...
La fonction `generate_fiche_cq_station` permet de générer une ou plusieurs fiches CQ de station(s). Elle a été pensé pour pouvoir sélectionner une période de temps voulue pour inspecter les données bancarisées sur la station (→ dans le but de la mise en qualité des données !)
...
> Pour générer deux fiches sur deux stations sur la période 2007 à 2022 :
...
<iframe src="docs/figures/fiche_CQ_donnees_station_03174000_005.html" height="405" width="720" style="border: 1px solid #464646;" allowfullscreen="" allow="autoplay" data-external="1"></iframe>